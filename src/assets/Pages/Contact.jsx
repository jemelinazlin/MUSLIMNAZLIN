...
function Contact() {
  return (
    <section
      ...
      style={{
        backgroundImage: "url('https://wallpapercave.com/wp/YHlk56g.jpg')", // Replace with your image URL
      }}
    >
      <div className="container mx-auto flex items-center justify-start px-6">
        {/* Left Side: Form Section */}
        <div className="max-w-lg w-full text-left bg-white bg-opacity-90 p-10 rounded-2xl shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-3xl">
        ...
        <div className="hidden lg:block ml-16 text-white">
          <h3 className="text-3xl font-semibold mb-4 text-shadow-lg text-black">
